...
//  MyPlaces
//
//  Created by Pisarev Dmitriy on 16.05.2021.
//
...
class MapManager {
    ...
    func checkLokationServices(mapView: MKMapView, segueIdentifier: String, closure: () -> ()) {
    ...
    CLLocation) -> ()) {
        ...
        guard center.distance(from: location) > 1 else { return }
